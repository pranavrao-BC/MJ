/* SQL generated to create new entity MJ: AI Agent Sessions */
      ...
      VALUES (
         '4203b84b-dbf8-4655-aac9-c0d99523a46a',
...
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ...
                                       ('EBA5CCEC-6A37-EF11-86D4-000D3A4E707E', '4203b84b-dbf8-4655-aac9-c0d99523a46a', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = 'EBA5CCEC-6A37-EF11-86D4-000D3A4E707E'), GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Sessions for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('4203b84b-dbf8-4655-aac9-c0d99523a46a', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Sessions for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('4203b84b-dbf8-4655-aac9-c0d99523a46a', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Sessions for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('4203b84b-dbf8-4655-aac9-c0d99523a46a', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '2bcb7cdf-81a9-4383-8880-e15f7ef1b7e2' OR (EntityID = '5190AF93-4C39-4429-BDAA-0AEB492A0256' AND Name = 'SessionID')) BEGIN
         ...
         VALUES
         (
            '2bcb7cdf-81a9-4383-8880-e15f7ef1b7e2',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '7c8ada33-7bbf-49e3-8031-92581692202e' OR (EntityID = '12248F34-2837-EF11-86D4-6045BDEE16E6' AND Name = 'SessionID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '7c8ada33-7bbf-49e3-8031-92581692202e',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'd0b08150-851b-45cd-8be2-fdb95ccdf4fc' OR (EntityID = '4203B84B-DBF8-4655-AAC9-C0D99523A46A' AND Name = 'ID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'd0b08150-851b-45cd-8be2-fdb95ccdf4fc',
            '4203B84B-DBF8-4655-AAC9-C0D99523A46A', -- Entity: MJ: AI Agent Sessions
            100001,
            'ID',
            'ID',
            NULL,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '03acda7c-b5a1-4bd3-bd72-42c2e94baabf' OR (EntityID = '4203B84B-DBF8-4655-AAC9-C0D99523A46A' AND Name = 'AgentID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '03acda7c-b5a1-4bd3-bd72-42c2e94baabf',
            '4203B84B-DBF8-4655-AAC9-C0D99523A46A', -- Entity: MJ: AI Agent Sessions
            100002,
            'AgentID',
            'Agent ID',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '044b4afd-f91c-4374-9159-3d76c49ce50a' OR (EntityID = '4203B84B-DBF8-4655-AAC9-C0D99523A46A' AND Name = 'UserID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '044b4afd-f91c-4374-9159-3d76c49ce50a',
            '4203B84B-DBF8-4655-AAC9-C0D99523A46A', -- Entity: MJ: AI Agent Sessions
            100003,
            'UserID',
            'User ID',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '3fade419-4b6a-42af-9262-3523bcede606' OR (EntityID = '4203B84B-DBF8-4655-AAC9-C0D99523A46A' AND Name = 'Status')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '3fade419-4b6a-42af-9262-3523bcede606',
            '4203B84B-DBF8-4655-AAC9-C0D99523A46A', -- Entity: MJ: AI Agent Sessions
            100004,
            'Status',
            'Status',
            'Lifecycle status of the session: Active (live connection), Idle (no recent activity), Closed (socket terminated). The conversation and its details remain after a session closes.',
            'nvarchar',
            40,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '532c7795-10f9-4353-ad48-4b3f38e076f3' OR (EntityID = '4203B84B-DBF8-4655-AAC9-C0D99523A46A' AND Name = 'ConversationID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '532c7795-10f9-4353-ad48-4b3f38e076f3',
            '4203B84B-DBF8-4655-AAC9-C0D99523A46A', -- Entity: MJ: AI Agent Sessions
            100005,
            'ConversationID',
            'Conversation ID',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '5c6cae02-da38-4e95-b55b-d544e3d928cb' OR (EntityID = '4203B84B-DBF8-4655-AAC9-C0D99523A46A' AND Name = 'Config')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '5c6cae02-da38-4e95-b55b-d544e3d928cb',
            '4203B84B-DBF8-4655-AAC9-C0D99523A46A', -- Entity: MJ: AI Agent Sessions
            100006,
            'Config',
            'Config',
            'Session-specific state and variables as a JSON block (e.g. negotiated codecs, per-session settings).',
            'nvarchar',
            -1,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'b022cbbc-4dc5-4d5a-a055-0e7530a38e61' OR (EntityID = '4203B84B-DBF8-4655-AAC9-C0D99523A46A' AND Name = 'ActiveChannels')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'b022cbbc-4dc5-4d5a-a055-0e7530a38e61',
            '4203B84B-DBF8-4655-AAC9-C0D99523A46A', -- Entity: MJ: AI Agent Sessions
            100007,
            'ActiveChannels',
            'Active Channels',
            'JSON array of the channels currently active on this session, e.g. [{ channelId, socketUrl, status, config }]. Tracked dynamically rather than in a normalized sub-table.',
            'nvarchar',
            -1,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '72736efc-cf00-43e4-bee7-7d72b441217a' OR (EntityID = '4203B84B-DBF8-4655-AAC9-C0D99523A46A' AND Name = 'LastActiveAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '72736efc-cf00-43e4-bee7-7d72b441217a',
            '4203B84B-DBF8-4655-AAC9-C0D99523A46A', -- Entity: MJ: AI Agent Sessions
            100008,
            'LastActiveAt',
            'Last Active At',
            'Timestamp (with offset) of the last activity on the session, used for idle detection and expiry.',
            'datetimeoffset',
            10,
            34,
            7,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '026579b8-1b98-4a00-9bcb-69704875bfdf' OR (EntityID = '4203B84B-DBF8-4655-AAC9-C0D99523A46A' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '026579b8-1b98-4a00-9bcb-69704875bfdf',
            '4203B84B-DBF8-4655-AAC9-C0D99523A46A', -- Entity: MJ: AI Agent Sessions
            100009,
            '__mj_CreatedAt',
            'Created At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '7dd6ade5-77e4-4ecf-954b-0acfb7de7bb5' OR (EntityID = '4203B84B-DBF8-4655-AAC9-C0D99523A46A' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '7dd6ade5-77e4-4ecf-954b-0acfb7de7bb5',
            '4203B84B-DBF8-4655-AAC9-C0D99523A46A', -- Entity: MJ: AI Agent Sessions
            100010,
            '__mj_UpdatedAt',
            'Updated At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'd9b9aa47-60e1-4b85-a73a-6cfd865acbd9' OR (EntityID = 'EDF930B7-859B-4892-A029-E7EBB4254FBD' AND Name = 'ServerPluginClass')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'd9b9aa47-60e1-4b85-a73a-6cfd865acbd9',
            'EDF930B7-859B-4892-A029-E7EBB4254FBD', -- Entity: MJ: AI Agent Channels
            100019,
            'ServerPluginClass',
            'Server Plugin Class',
            'ClassFactory registration key for the server-side channel plugin implementing IAgentChannelServer (manages the WebSocket/WebRTC connection and streams data both ways).',
            'nvarchar',
            500,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '9125181d-7439-4f97-b42b-f99f7cff2d47' OR (EntityID = 'EDF930B7-859B-4892-A029-E7EBB4254FBD' AND Name = 'ClientPluginClass')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '9125181d-7439-4f97-b42b-f99f7cff2d47',
            'EDF930B7-859B-4892-A029-E7EBB4254FBD', -- Entity: MJ: AI Agent Channels
            100020,
            'ClientPluginClass',
            'Client Plugin Class',
            'ClassFactory registration key for the client-side channel plugin implementing IAgentChannelClient (establishes the socket, captures user input, renders agent events).',
            'nvarchar',
            500,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'e34a529e-aaed-4eb4-9dff-5d85f1bdbce2' OR (EntityID = 'EDF930B7-859B-4892-A029-E7EBB4254FBD' AND Name = 'ConfigSchema')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'e34a529e-aaed-4eb4-9dff-5d85f1bdbce2',
            'EDF930B7-859B-4892-A029-E7EBB4254FBD', -- Entity: MJ: AI Agent Channels
            100021,
            'ConfigSchema',
            'Config Schema',
            'Optional JSON Schema used to validate the parameters supplied when activating this channel on a session.',
            'nvarchar',
            -1,
            0,
            0,
...
/* SQL text to insert entity field value with ID 1fd4455b-8b75-4b58-933d-a002b6878e1b */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('1fd4455b-8b75-4b58-933d-a002b6878e1b', '3FADE419-4B6A-42AF-9262-3523BCEDE606', 1, 'Active', 'Active', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID ed1a2f21-2c94-4733-90f4-30ce21c3d3af */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('ed1a2f21-2c94-4733-90f4-30ce21c3d3af', '3FADE419-4B6A-42AF-9262-3523BCEDE606', 2, 'Closed', 'Closed', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID 98689d3c-a0ee-40b9-b5f1-faca2d36624c */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('98689d3c-a0ee-40b9-b5f1-faca2d36624c', '3FADE419-4B6A-42AF-9262-3523BCEDE606', 3, 'Idle', 'Idle', GETUTCDATE(), GETUTCDATE());

/* SQL text to update ValueListType for entity field ID 3FADE419-4B6A-42AF-9262-3523BCEDE606 */
UPDATE [${flyway:defaultSchema}].[EntityField] SET ValueListType='List' WHERE ID='3FADE419-4B6A-42AF-9262-3523BCEDE606';


/* Create Entity Relationship: MJ: AI Agents -> MJ: AI Agent Sessions (One To Many via AgentID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = 'ba2f86db-023a-4c96-a087-6cb1b9dc4d5a'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('ba2f86db-023a-4c96-a087-6cb1b9dc4d5a', 'CDB135CC-6D3C-480B-90AE-25B7805F82C1', '4203B84B-DBF8-4655-AAC9-C0D99523A46A', 'AgentID', 'One To Many', 1, 1, 29, GETUTCDATE(), GETUTCDATE())
   END;


/* Create Entity Relationship: MJ: Users -> MJ: AI Agent Sessions (One To Many via UserID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = 'cace62bf-f09c-45a0-b7da-954511b2036b'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('cace62bf-f09c-45a0-b7da-954511b2036b', 'E1238F34-2837-EF11-86D4-6045BDEE16E6', '4203B84B-DBF8-4655-AAC9-C0D99523A46A', 'UserID', 'One To Many', 1, 1, 99, GETUTCDATE(), GETUTCDATE())
   END;


/* Create Entity Relationship: MJ: Conversations -> MJ: AI Agent Sessions (One To Many via ConversationID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = 'a09d3c2d-be14-4cf2-8ba5-f8d387c82a92'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('a09d3c2d-be14-4cf2-8ba5-f8d387c82a92', '13248F34-2837-EF11-86D4-6045BDEE16E6', '4203B84B-DBF8-4655-AAC9-C0D99523A46A', 'ConversationID', 'One To Many', 1, 1, 7, GETUTCDATE(), GETUTCDATE())
   END;


/* Create Entity Relationship: MJ: AI Agent Sessions -> MJ: AI Agent Runs (One To Many via SessionID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '949b0d7e-0fee-44ac-8d0f-14075e2f9a86'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('949b0d7e-0fee-44ac-8d0f-14075e2f9a86', '4203B84B-DBF8-4655-AAC9-C0D99523A46A', '5190AF93-4C39-4429-BDAA-0AEB492A0256', 'SessionID', 'One To Many', 1, 1, 1, GETUTCDATE(), GETUTCDATE())
   END;
                    
/* Create Entity Relationship: MJ: AI Agent Sessions -> MJ: Conversation Details (One To Many via SessionID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '320d3360-f6d7-4445-a8b8-ff70029a11c1'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('320d3360-f6d7-4445-a8b8-ff70029a11c1', '4203B84B-DBF8-4655-AAC9-C0D99523A46A', '12248F34-2837-EF11-86D4-6045BDEE16E6', 'SessionID', 'One To Many', 1, 1, 2, GETUTCDATE(), GETUTCDATE())
   END;
...
CREATE PROCEDURE [${flyway:defaultSchema}].[spCreateAIAgentChannel]
    ...
    @ServerPluginClass_Clear bit = 0,
    @ServerPluginClass nvarchar(250) = NULL,
    @ClientPluginClass_Clear bit = 0,
    ...
    BEGIN
        ...
        VALUES
            (
                ...
                CASE WHEN @ServerPluginClass_Clear = 1 THEN NULL ELSE ISNULL(@ServerPluginClass, NULL) END,
                CASE WHEN @ClientPluginClass_Clear = 1 THEN NULL ELSE ISNULL(@ClientPluginClass, NULL) END,
...
BEGIN
    ...
    SET
        ...
        [ServerPluginClass] = CASE WHEN @ServerPluginClass_Clear = 1 THEN NULL ELSE ISNULL(@ServerPluginClass, [ServerPluginClass]) END,
        [ClientPluginClass] = CASE WHEN @ClientPluginClass_Clear = 1 THEN NULL ELSE ISNULL(@ClientPluginClass, [ClientPluginClass]) END,
...
-- Index for foreign key SessionID in table AIAgentRun
IF NOT EXISTS (
    SELECT 1
    FROM sys.indexes
    WHERE name = 'IDX_AUTO_MJ_FKEY_AIAgentRun_SessionID' 
    AND object_id = OBJECT_ID('[${flyway:defaultSchema}].[AIAgentRun]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_AIAgentRun_SessionID ON [${flyway:defaultSchema}].[AIAgentRun] ([SessionID]);
    ...
    BEGIN
        ...
        VALUES
            (
                ...
                CASE WHEN @SessionID_Clear = 1 THEN NULL ELSE ISNULL(@SessionID, NULL) END
            )
    END
    ELSE
    BEGIN
...
BEGIN
    ...
    SET
        ...
        [SessionID] = CASE WHEN @SessionID_Clear = 1 THEN NULL ELSE ISNULL(@SessionID, [SessionID]) END
    WHERE
        [ID] = @ID
...
BEGIN
    ...
    DECLARE @MJAIAgentRuns_LastRunID_SessionID uniqueidentifier
...
/* SQL text to update entity field related entity name field map for entity field ID 03ACDA7C-B5A1-4BD3-BD72-42C2E94BAABF */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='03ACDA7C-B5A1-4BD3-BD72-42C2E94BAABF', @RelatedEntityNameFieldMap='Agent';

/* SQL text to update entity field related entity name field map for entity field ID 044B4AFD-F91C-4374-9159-3D76C49CE50A */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='044B4AFD-F91C-4374-9159-3D76C49CE50A', @RelatedEntityNameFieldMap='User';

/* SQL text to update entity field related entity name field map for entity field ID 532C7795-10F9-4353-AD48-4B3F38E076F3 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='532C7795-10F9-4353-AD48-4B3F38E076F3', @RelatedEntityNameFieldMap='Conversation';
    ...
    BEGIN
        ...
        VALUES
            (
                ...
                CASE WHEN @ActiveChannels_Clear = 1 THEN NULL ELSE ISNULL(@ActiveChannels, NULL) END,
...
BEGIN
    ...
    SET
        ...
        [ActiveChannels] = CASE WHEN @ActiveChannels_Clear = 1 THEN NULL ELSE ISNULL(@ActiveChannels, [ActiveChannels]) END,
...
-- Index for foreign key SessionID in table ConversationDetail
IF NOT EXISTS (
    SELECT 1
    FROM sys.indexes
    WHERE name = 'IDX_AUTO_MJ_FKEY_ConversationDetail_SessionID' 
    AND object_id = OBJECT_ID('[${flyway:defaultSchema}].[ConversationDetail]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_ConversationDetail_SessionID ON [${flyway:defaultSchema}].[ConversationDetail] ([SessionID]);
...
BEGIN
    ...
    DECLARE @MJAIAgentRuns_ConversationDetailID_SessionID uniqueidentifier
...
BEGIN
    ...
    DECLARE @MJConversationDetails_ArtifactVersionID_SessionID uniqueidentifier
...
BEGIN
    ...
    DECLARE @MJConversationDetails_ArtifactID_SessionID uniqueidentifier
...
BEGIN
    ...
    DECLARE @MJAIAgentRuns_ConversationID_SessionID uniqueidentifier
    ...
    DECLARE @MJAIAgentSessions_ConversationID_ActiveChannels nvarchar(MAX)
    ...
    BEGIN
        ...
        -- Call the update SP for the related entity
        EXEC [${flyway:defaultSchema}].[spUpdateAIAgentSession] @ID = @MJAIAgentSessions_ConversationIDID, @AgentID = @MJAIAgentSessions_ConversationID_AgentID, @UserID = @MJAIAgentSessions_ConversationID_UserID, @Status = @MJAIAgentSessions_ConversationID_Status, @ConversationID_Clear = 1, @ConversationID = @MJAIAgentSessions_ConversationID_ConversationID, @Config = @MJAIAgentSessions_ConversationID_Config, @ActiveChannels = @MJAIAgentSessions_ConversationID_ActiveChannels, @LastActiveAt = @MJAIAgentSessions_ConversationID_LastActiveAt
...
BEGIN
    ...
    DECLARE @MJConversationDetails_AgentID_SessionID uniqueidentifier
...
BEGIN
    ...
    DECLARE @MJAIAgentRuns_ConfigurationID_SessionID uniqueidentifier
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'bbb18fc7-d1fa-4171-b73c-29090b3cd756' OR (EntityID = '4203B84B-DBF8-4655-AAC9-C0D99523A46A' AND Name = 'Agent')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'bbb18fc7-d1fa-4171-b73c-29090b3cd756',
            '4203B84B-DBF8-4655-AAC9-C0D99523A46A', -- Entity: MJ: AI Agent Sessions
            100021,
            'Agent',
            'Agent',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '7d34e189-d6ca-4704-b15a-5a5195fcae71' OR (EntityID = '4203B84B-DBF8-4655-AAC9-C0D99523A46A' AND Name = 'User')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '7d34e189-d6ca-4704-b15a-5a5195fcae71',
            '4203B84B-DBF8-4655-AAC9-C0D99523A46A', -- Entity: MJ: AI Agent Sessions
            100022,
            'User',
            'User',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '61ed6082-db83-461a-bc40-3bd8602a03fb' OR (EntityID = '4203B84B-DBF8-4655-AAC9-C0D99523A46A' AND Name = 'Conversation')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '61ed6082-db83-461a-bc40-3bd8602a03fb',
            '4203B84B-DBF8-4655-AAC9-C0D99523A46A', -- Entity: MJ: AI Agent Sessions
            100023,
            'Conversation',
            'Conversation',
